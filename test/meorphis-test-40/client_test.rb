...
class MeorphisTest40Test < Test::Unit::TestCase
  ...
  def test_client_default_request_default_retry_attempts
    ...
    meorphis_test_45.requester = requester
    assert_raise(MeorphisTest40::HTTP::InternalServerError) do
      meorphis_test_45.cards.create({type: "VIRTUAL"})
    end
    assert_equal(3, requester.attempts.length)
  end

  def test_client_given_request_default_retry_attempts
    meorphis_test_45 = MeorphisTest40::Client.new(base_url: "http://localhost:4010", max_retries: 3)
    requester = MockRequester.new(500, {}, {"x-stainless-mock-sleep" => "true"})
    meorphis_test_45.requester = requester
    assert_raise(MeorphisTest40::HTTP::InternalServerError) do
      meorphis_test_45.cards.create({type: "VIRTUAL"})
  ...
  def test_client_default_request_given_retry_attempts
    ...
    meorphis_test_45.requester = requester
    assert_raise(MeorphisTest40::HTTP::InternalServerError) do
      meorphis_test_45.cards.create({type: "VIRTUAL"}, max_retries: 3)
    end
    assert_equal(4, requester.attempts.length)
  end
  ...
  def test_client_given_request_given_retry_attempts
    ...
    meorphis_test_45.requester = requester
    assert_raise(MeorphisTest40::HTTP::InternalServerError) do
      meorphis_test_45.cards.create({type: "VIRTUAL"}, max_retries: 4)
    end
    assert_equal(5, requester.attempts.length)
  end

  def test_client_retry_after_seconds
    meorphis_test_45 = MeorphisTest40::Client.new(base_url: "http://localhost:4010", max_retries: 1)
  ...
  def test_omit_retry_count_header
    ...
    assert_raise(MeorphisTest40::HTTP::InternalServerError) do
      meorphis_test_45.cards.create({type: "VIRTUAL"}, extra_headers: {"X-Stainless-Retry-Count" => nil})
    end
  ...
  def test_overwrite_retry_count_header
    ...
    assert_raise(MeorphisTest40::HTTP::InternalServerError) do
      meorphis_test_45.cards.create({type: "VIRTUAL"}, extra_headers: {"X-Stainless-Retry-Count" => "42"})
    end
  ...
  def test_client_redirect_307
    ...
    assert_raise(MeorphisTest40::HTTP::APIConnectionError) do
      meorphis_test_45.cards.create({type: "VIRTUAL"}, extra_headers: {})
    end
  ...
  def test_client_redirect_auth_keep_same_origin
    ...
    meorphis_test_45.requester = requester
    assert_raise(MeorphisTest40::HTTP::APIConnectionError) do
      meorphis_test_45.cards.create({type: "VIRTUAL"}, extra_headers: {"Authorization" => "Bearer xyz"})
    end
    assert_equal(
