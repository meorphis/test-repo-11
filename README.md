# Meorphis Test 44 Ruby API library

The Meorphis Test 44 Ruby library provides convenient access to the Meorphis Test 44 REST API from any Ruby 3.0+
application.
...
meorphis_test_44 = MeorphisTest40::Client.new(
  environment: "environment_1" # defaults to "production"
)

card = meorphis_test_44.cards.create(type: "REPLACE_ME")
...
meorphis_test_44.cards.create(type: "REPLACE_ME", max_retries: 5)
```
