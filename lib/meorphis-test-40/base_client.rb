  ...
  class BaseClient
    ...
    def initialize(
      ...
      base_headers = {
        ...
        "X-Stainless-Package-Version" => MeorphisTest40::VERSION,
    ...
    def validate_request(req, opts)
      ...
      unless opts.is_a?(Hash) || opts.is_a?(MeorphisTest40::RequestOption)
      ...
      opts.to_h.each_key do |k|
        ...
        unless (valid_keys = MeorphisTest40::RequestOptions.options).include?(k)
