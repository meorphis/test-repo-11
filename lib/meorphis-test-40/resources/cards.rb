...
module MeorphisTest40
  module Resources
    class Cards
      ...
      #   @option params [String, nil] :account_token Body param: Globally unique identifier for the account that the card will be
      ...
      #   @option params [String, nil] :card_program_token Body param: For card programs with more than one BIN range. This must be
      ...
      #     programs.
      #   @option params [Carrier, nil] :carrier Body param:
      #   @option params [String, nil] :digital_card_art_token Body param: Specifies the digital card art to be displayed in the user’s digital
      ...
      #   @option params [String, nil] :exp_month Body param: Two digit (MM) expiry month. If neither `exp_month` nor `exp_year`
      #     is provided, an expiration date will be generated.
      #   @option params [String, nil] :exp_year Body param: Four digit (yyyy) expiry year. If neither `exp_month` nor `exp_year`
      #     is provided, an expiration date will be generated.
      #   @option params [String, nil] :memo Body param: Friendly name to identify the card. We recommend against using this
      #     field to store JSON data as it can cause unexpected behavior.
      #   @option params [String, nil] :pin Body param: Encrypted PIN block (in base64). Only applies to cards of type
      #     `PHYSICAL` and `VIRTUAL`. See
      #     [Encrypted PIN Block](https://docs.acme.com/docs/cards#encrypted-pin-block-enterprise).
      #   @option params [String, nil] :product_id Body param: Only applicable to cards of type `PHYSICAL`. This must be configured
      #     with Acme before use. Specifies the configuration (i.e., physical card art) that
      #     the card should be manufactured with.
      #   @option params [ShippingAddress, nil] :shipping_address Body param:
      #   @option params [Symbol, ShippingMethod, nil] :shipping_method Body param: Shipping method for the card. Only applies to cards of type
      ...
      #       tracking
      #   @option params [Integer, nil] :spend_limit Body param: Amount (in cents) to limit approved authorizations. Transaction
      ...
      #       time.
      #   @option params [String, nil] :idempotency_key Header param: Idempotency key for the POST request. See
      ...
      def create(params = {}, opts = {})
        req = {
          ...
          model: MeorphisTest40::Models::Card
        }
      ...
      #     with the card.
      #   @option params [String, nil] :digital_card_art_token Specifies the digital card art to be displayed in the user’s digital wallet
      #     after tokenization. This artwork must be approved by Mastercard and configured
      #     by Acme to use. See
      #     [Flexible Card Art Guide](https://docs.acme.com/docs/about-digital-wallets#flexible-card-art).
      #   @option params [String, nil] :memo Friendly name to identify the card. We recommend against using this field to
      ...
      #
      # @param params [Hash] Attributes to send in this request.
      #   @option params [String, nil] :certificate Body param: Only applicable if `digital_wallet` is `APPLE_PAY`. Omit to receive
      ...
      #   @option params [Symbol, DigitalWallet, nil] :digital_wallet Body param: Name of digital wallet provider.
      #   @option params [String, nil] :nonce Body param: Only applicable if `digital_wallet` is `APPLE_PAY`. Omit to receive
      #     only `activationData` in the response. Base64 cryptographic nonce provided by
      #     the device's wallet.
      #   @option params [String, nil] :nonce_signature Body param: Only applicable if `digital_wallet` is `APPLE_PAY`. Omit to receive
      #     only `activationData` in the response. Base64 cryptographic nonce provided by
      #     the device's wallet.
      #   @option params [String, nil] :idempotency_key Header param: Idempotency key for the POST request. See
      #     [Idempotency Requests](https://docs.acme.com/docs/idempotent-requests) for
      ...
      def provision(card_token, params = {}, opts = {})
        req = {
          ...
          body: params,
          headers: {"Content-Type" => "application/json"},
          model: MeorphisTest40::Models::CardProvisionResponse
        }
        @client.request(req, opts)
      end
    end
