...
module MeorphisTest40
  module Models
    class Card < BaseModel
      ...
      #
      #   @return [Symbol, MeorphisTest40::Models::Card::SpendLimitDuration]
      ...
      #
      #   @return [Symbol, MeorphisTest40::Models::Card::State]
      ...
      #
      #   @return [Symbol, MeorphisTest40::Models::Card::Type]
      ...
      class Funding < BaseModel
        ...
        #
        #   @return [Symbol, MeorphisTest40::Models::Card::Funding::State]
        ...
        #
        #   @return [Symbol, MeorphisTest40::Models::Card::Funding::Type]
        ...
        # @!parse
        #   # Create a new instance of Funding from a Hash of raw data.
        #   #
        #   # @param data [Hash{Symbol => Object}] .
        #   #   @option data [String] :token A globally unique identifier for this FundingAccount.
        #   #   @option data [String] :created An RFC 3339 string representing when this funding source was added to the Acme
        #   #     account. This may be `null`. UTC time zone.
        #   #   @option data [String] :last_four The last 4 digits of the account (e.g. bank account, debit card) associated with
        ...
        #   #     - `DEPOSITORY_CHECKING` - Bank checking account.
        #   #     - `DEPOSITORY_SAVINGS` - Bank savings account.
        #   #   @option data [String, nil] :account_name Account name identifying the funding source. This may be `null`.
        #   #   @option data [String, nil] :nickname The nickname given to the `FundingAccount` or `null` if it has no nickname.
      ...
      #   #   @option data [String] :created An RFC 3339 timestamp for when the card was created. UTC time zone.
      #   #   @option data [Object] :funding
      #   #   @option data [String] :last_four Last four digits of the card number.
      ...
      #   #   @option data [String, nil] :digital_card_art_token Specifies the digital card art to be displayed in the user’s digital wallet
      ...
      #   #   @option data [String, nil] :memo Friendly name to identify the card. We recommend against using this field to
